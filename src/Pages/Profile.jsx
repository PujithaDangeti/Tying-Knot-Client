...
//     const storedName = localStorage.getItem("username") || "User Name";
//     const storedEmail = localStorage.getItem("email"); // Get logged-in user's email
//     const storedBio = localStorage.getItem("bio");
//     const parsedBio = storedBio
//       ? JSON.parse(storedBio)
//       : { phone: "", age: "", profession: "", location: "", hobbies: "" };
...
//   const handleSaveBio = () => {
//     const newErrors = {};
//     if (!bio.phone || !/^\d{10}$/.test(bio.phone)) {
//       newErrors.phone = "Please enter a valid 10-digit phone number.";
//     }
//     if (!bio.age || isNaN(bio.age) || bio.age <= 0) {
//       newErrors.age = "Please enter a valid age.";
//     }
//     if (!bio.profession.trim()) {
//       newErrors.profession = "Profession is required.";
//     }
//     if (!bio.location.trim()) {
...
//     setName("");
//     setEmail("");
//     setBio({ phone: "", age: "", profession: "", location: "", hobbies: "" });
//     setErrors({});
//   };
...
//                 value={bio.profession}
//                 error={errors.profession}
//                 onChange={(e) => handleBioChange("profession", e.target.value)}
//               />
//               {errors.profession && <ErrorText>{errors.profession}</ErrorText>}
//             </BioField>
//             <BioField>
...
//                 onChange={(e) => handleBioChange("hobbies", e.target.value)}
//               />
//               {errors.hobbies && <ErrorText>{errors.hobbies}</ErrorText>}
//             </BioField>
